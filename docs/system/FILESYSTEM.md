...
Views are regenerated by replaying the event log, and the backend does this
...
To rebuild deliberately without a restart, the backend ships scripts for each
derived read model:
