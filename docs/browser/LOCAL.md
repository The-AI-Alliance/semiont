...
Run the Semiont Browser locally. The browser is a static SPA that connects to a running gateway. For the broader browser-persona docs (running it as an end user, accessibility, shortcuts, features), see **[README.md](README.md)**.
...
Open **http://localhost:3000** and enter the gateway URL (e.g. **http://localhost:4000**) in the connection form.
