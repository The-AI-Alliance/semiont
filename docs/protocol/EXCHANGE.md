...
For lossless backup and restore (complete event history, exact reconstruction), see [Backup & Restore](../system/administration/BACKUP.md). Full backup requires the admin role.
