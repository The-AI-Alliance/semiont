...
All endpoint details, schemas, and request/response formats are defined in the [OpenAPI specification](../../specs/src/openapi.json):
...
See the [OpenAPI specification](../../specs/src/) for complete endpoint details.
