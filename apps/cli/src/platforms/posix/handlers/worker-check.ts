 ...
 */
const checkWorkerProcess = async (context: PosixCheckHandlerContext): Promise<CheckHandlerResult> => {
 ...
 */
export const workerCheckDescriptor: HandlerDescriptor<PosixCheckHandlerContext, CheckHandlerResult> = {
  command: 'check',
  platform: 'posix',
  serviceType: 'worker',
