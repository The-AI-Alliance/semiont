/**
 * Highlight Detection API Tests
 *
 * Tests the HTTP contract of the POST /resources/:resourceId/annotate-highlights endpoint.
...
describe('POST /resources/:resourceId/annotate-highlights', () => {
  ...
  it('should accept request and return 202 with correlationId', async () => {
    const response = await app.request('/resources/test-resource/annotate-highlights', {
      method: 'POST',
      headers: {
  ...
  it('should handle resource not found', async () => {
    ...
    const response = await app.request('/resources/nonexistent-resource/annotate-highlights', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${authToken}`,
        'Content-Type': 'application/json',
