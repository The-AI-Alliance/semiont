...
export function registerAnnotateAssessments(router: ResourcesRouterType, jobQueue: JobQueue) {
  router.post('/resources/:id/annotate-assessments',
    ...
    async (c) => {
      ...
      const logger = getLogger().child({
        component: 'annotate-assessments',
        resourceId: id
      });
