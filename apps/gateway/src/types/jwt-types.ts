 ...
 *
 * `did` is the identity everything downstream keys on, so carrying it directly
 * means the token says what the bus, resource creation and the signal ledger
 * all read — with no lookup in between to disagree.
 */
