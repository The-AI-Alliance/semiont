...
- [DATABASE.md](../../../docs/DATABASE.md) - PostgreSQL event store and projection layers
- [GRAPH.md](../../../docs/GRAPH.md) - Graph database implementations (Neo4j, Neptune, JanusGraph)