...
**Frontend-specific**:
- `NEXT_PUBLIC_API_URL` - Backend API URL for browser (embedded at build time)
- `SERVER_API_URL` - Backend API URL for server-side calls (runtime, optional - defaults to NEXT_PUBLIC_API_URL)
