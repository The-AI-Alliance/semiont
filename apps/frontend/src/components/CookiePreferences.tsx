            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Manage your cookie preferences and privacy settings. Changes will take effect immediately.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <p className="mt-2 text-xs text-gray-500">
                  Export includes all cookies, local storage, and session data. Delete will remove all data and reload the page.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      This will permanently delete all your data including cookies, preferences, and session information. This action cannot be undone and will reload the page.
                    </p>
                  </div>
                </div>
              </div>
