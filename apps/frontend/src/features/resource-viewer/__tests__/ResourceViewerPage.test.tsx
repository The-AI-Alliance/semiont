...
vi.mock('@semiont/react-ui', async () => {
  ...
  return {
    ...
    withHandlers: (handlers: any) => handlers,
    createDetectionHandler: () => vi.fn(),
...
const createMockProps = (overrides?: Partial<ResourceViewerPageProps>): ResourceViewerPageProps => ({
  ...
  onAnnotationBodyUpdated: vi.fn(),
  onDocumentArchived: vi.fn(),
  onDocumentUnarchived: vi.fn(),
  onEntityTagAdded: vi.fn(),
  onEntityTagRemoved: vi.fn(),
  onEventError: vi.fn(),
  cacheManager: {},
  client: {},
