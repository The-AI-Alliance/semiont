...
describe('AuthErrorDisplay', () => {
  describe('Error Message Display', () => {
    it('displays Configuration error message', () => {
      render(<AuthErrorDisplay errorType="Configuration" translations={mockTranslations} />);
    ...
    it('displays AccessDenied error message', () => {
      render(<AuthErrorDisplay errorType="AccessDenied" translations={mockTranslations} />);
    ...
    it('displays Verification error message', () => {
      render(<AuthErrorDisplay errorType="Verification" translations={mockTranslations} />);
    ...
    it('displays generic error message for unknown error type', () => {
      render(<AuthErrorDisplay errorType="UnknownError" translations={mockTranslations} />);
    ...
    it('displays generic error message when errorType is null', () => {
      render(<AuthErrorDisplay errorType={null} translations={mockTranslations} />);
