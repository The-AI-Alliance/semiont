...
export type GetHighlightsResponse = paths['/api/documents/{id}/highlights']['get']['responses'][200]['content']['application/json'];
export type GetReferencesResponse = paths['/api/documents/{id}/references']['get']['responses'][200]['content']['application/json'];
