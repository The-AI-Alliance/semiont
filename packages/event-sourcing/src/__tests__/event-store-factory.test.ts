...
describe('createEventStore', () => {
  ...
  describe('Factory function', () => {
    ...
    it('should create EventStore with sharding disabled', () => {
      const eventStore = createEventStore(testDir, testDir, {
  ...
  describe('Config validation', () => {
    ...
    it('should require absolute basePath', () => {
      expect(() => createEventStore('relative/path', testDir, undefined, undefined, mockLogger)).toThrow(
  ...
  describe('Component initialization', () => {
    ...
    it('should share EventSubscriptions singleton across EventBus instances', () => {
      const eventStore1 = createEventStore(testDir, testDir, undefined, undefined, mockLogger);
      const eventStore2 = createEventStore(testDir, testDir, undefined, undefined, mockLogger);
