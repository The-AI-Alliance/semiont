 ...
 * @emits navigation:click - Annotation clicked. Payload: { annotationId: string, motivation: Motivation }
 */
            ...
            return (
              <g key={annotation.id}>
                ...
                <rect
                  ...
                  onClick={() => eventBus?.get('navigation:click').next({ annotationId: annotation.id, motivation: annotation.motivation })}
                ...
                {statusEmoji && (
                  <text
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      eventBus?.get('navigation:click').next({ annotationId: annotation.id, motivation: annotation.motivation });
                    }}
                    onMouseEnter={() => handleMouseEnter(annotation.id)}
                    onMouseLeave={handleMouseLeave}
                  >
