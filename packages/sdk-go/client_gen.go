...
type BindBodyUpdated = map[string]interface{}
...
type BrowseAgentsRequest = map[string]interface{}
...
type BrowseEntityTypesRequest = map[string]interface{}
...
type BrowseTagSchemasRequest = map[string]interface{}
