...
const (
	...
	// payload: BrowseAnchoredTextByChecksumRequest
	BrowseAnchoredTextByChecksumRequested Channel = "browse:anchored-text-by-checksum-requested"

	// payload: BrowseAnchoredTextResult
	BrowseAnchoredTextByChecksumResult Channel = "browse:anchored-text-by-checksum-result"

	// not emittable (no registered schema)
	BrowseAnchoredTextByChecksumFailed Channel = "browse:anchored-text-by-checksum-failed"
...
var ChannelSchemas = map[Channel]string{
	...
	BrowseAnchoredTextByChecksumRequested: "BrowseAnchoredTextByChecksumRequest",
	BrowseAnchoredTextByChecksumResult:    "BrowseAnchoredTextResult",
