...
import type { AdminNamespace as IAdminNamespace, RequestContent, ResponseContent } from './types';

type AdminUserStatsResponse = components['schemas']['AdminUserStatsResponse'];
type AdminUsersListResponse = components['schemas']['AdminUsersListResponse'];
type AdminUpdateUserResponse = components['schemas']['AdminUpdateUserResponse'];
...
export class AdminNamespace implements IAdminNamespace {
  ...
  async users(): Promise<AdminUsersListResponse['users']> {
  ...
  async updateUser(userId: UserDID, data: RequestContent<paths['/api/admin/users/{id}']['patch']>): Promise<AdminUpdateUserResponse['user']> {
