 ...
 */
export declare function loadEnvironmentConfig(projectRoot: string | null, environment?: string): EnvironmentConfig;
/**
 ...
 */
export declare function archivistEndpoint(config: ArchivistAddressConfig): {
    base: string;
    headers: {
