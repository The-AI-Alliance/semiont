 ...
 * browser-safe.
 */
import { type SupportedMediaType } from './media-types';
/**
 ...
 */
export declare function storageFileName(name: string, format: SupportedMediaType): string;
/**
 ...
 */
export declare function deriveStorageUri(name: string, format: SupportedMediaType): string;
/**
 * The folder a resource lives in, WITHOUT a trailing slash — `''` when it sits
 * at the tree root. Accepts a `file://` URI or a bare path.
 */
export declare function folderOf(storageUri: string | undefined): string;
/**
 ...
 */
export declare function proposeStoragePath(folder: string, title: string, format: SupportedMediaType): string;
